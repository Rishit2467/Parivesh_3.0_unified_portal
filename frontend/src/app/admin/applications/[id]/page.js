        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="card">
            ...
            <dl className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
              ...
              <dt className="text-gray-500">Scrutiny Officer</dt><dd>{app.scrutiny_officer?.name || "Not assigned"}</dd>
              <dt className="text-gray-500">MoM Officer</dt><dd>{app.mom_officer?.name || "Not assigned"}</dd>
            </dl>
          </div>
