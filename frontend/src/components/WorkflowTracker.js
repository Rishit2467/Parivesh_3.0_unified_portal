...
const WORKFLOW_STEPS = [
  ...
  { key: "query_raised",         label: "Query Raised",      icon: "❓", color: "orange" },
  { key: "approved_for_meeting", label: "Approved",          icon: "✅", color: "green" },
  { key: "mom_preparation",      label: "MoM Preparation",   icon: "📋", color: "purple" },
  { key: "final_publication",    label: "Published",         icon: "📢", color: "emerald" },
];
